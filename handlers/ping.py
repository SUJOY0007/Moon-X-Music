...
async def help(client: Client, message: Message):
    ...
    await message.reply_sticker("CAACAgIAAx0CZD3aQwACJDBjJ-eZl2p-v4EhBIqoKsKApbreVAACZQgAAk12UUmzP2slgKFtESkE")
    jay = await message.reply_photo(
        photo=f"{PING_IMG}",
        caption=" Pinging...⚡ ",
    )
    await jay.edit_text(
        f"""<b> pong ping ! ⚡</b>\n  🏓 `{resp} ms`\n\n<b><u>{BOT_NAME} system stats:</u></b>\n\n✨ Uptime : {bot_uptime}\n🔮 Cpu : {cpu}%\n💫 Disk : {disk}%\n❤️ Ram : {mem}\n\n|| ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [ᴇxᴘᴏʀᴛ ɢᴀʙʙᴀʀ🥀](https://t.me/export_gabbar) ||""",
